...
INSERT INTO questions (question_index, text, section) VALUES (3, 'In considering a new job, what is most important to me is:', 'want') RETURNING id INTO q;
...
INSERT INTO questions (question_index, text, section) VALUES (6, 'The most important thing for the daily operation in our organization is:', 'should') RETURNING id INTO q;
...
INSERT INTO questions (question_index, text, section) VALUES (11, 'In a perfect world, my job would permit me to:', 'want') RETURNING id INTO q;
...
INSERT INTO questions (question_index, text, section) VALUES (23, 'In general, the most important reason for putting off an important decision is that:', 'is') RETURNING id INTO q;
...
INSERT INTO questions (question_index, text, section) VALUES (31, 'Managers in our organization are praised for:', 'should') RETURNING id INTO q;
...
INSERT INTO questions (question_index, text, section) VALUES (34, 'My colleagues expect me to:', 'should') RETURNING id INTO q;

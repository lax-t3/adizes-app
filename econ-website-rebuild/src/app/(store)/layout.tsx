...
// This route group owns the storefront's <html>/<body>. The Payload admin group
// renders its own via @payloadcms/next RootLayout, so there is no root app/layout.tsx
// (avoids nested <html> tags). suppressHydrationWarning guards against browser
// extensions (Grammarly etc.) injecting body attributes before hydration.

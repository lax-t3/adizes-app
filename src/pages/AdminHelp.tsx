    ...
    <div className="p-4 sm:p-8 max-w-4xl mx-auto">
      ...
      <div className="rounded-xl border border-gray-100 bg-gray-50 px-6 py-4">
        <p className="text-xs text-gray-500 leading-relaxed">
          <span className="font-medium text-gray-700">About this platform —</span> LEAP™ — Leadership Energy Alignment Profile — developed by the Heartfulness Institute of Leadership, powered by the Adizes PAEI Framework. For programme-related questions contact <a href="mailto:hello@hileadership.org" className="text-primary hover:underline">hello@hileadership.org</a>. For technical issues contact <a href="mailto:team@turiyaskills.co" className="text-primary hover:underline">team@turiyaskills.co</a>.
        </p>
      </div>
    </div>
  );
